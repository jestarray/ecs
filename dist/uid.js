...
var UIDGenerator = exports.UIDGenerator = function () {
  ...
  function UIDGenerator() {
    var salt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
var DefaultUIDGenerator = exports.DefaultUIDGenerator = new UIDGenerator(currentSalt++);

var isSaltedBy = exports.isSaltedBy = function isSaltedBy(entityId, salt) {
 ...
 */
var nextSalt = exports.nextSalt = function nextSalt() {
 ...
 */
var nextGenerator = exports.nextGenerator = function nextGenerator() {
